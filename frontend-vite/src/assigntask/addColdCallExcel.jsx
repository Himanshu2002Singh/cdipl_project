...
import logo from "../assets/logo-cdipl.jpg";

const AddColdCallExcel = ({ handleCloseaddcallExcelModal }) => {
    ...
    <div className="max-w-md w-full">
      <div className="p-8 rounded-2xl bg-white shadow">
        ...
        <label htmlFor="uploadFile1">
          <div className="hover:cursor-pointer p-12 border border-dashed rounded-lg border-customorange flex flex-col items-center justify-center">
            <svg
              fill="#000000"
              height="50px"
              width="50px"
            ...
            <h3 className="text-customorange my-4">Browse & Upload Pdf File</h3>
...
export default AddColdCallExcel;
